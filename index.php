...
?>
	<div id="main">
		...
		<div class="intro">
			...
			<p>I like to build. Art, family, music, muscles (in progress), meals. Even things that grow &mdash; I am a Gardner after all. I'm driven to craft memorable experiences. Last year, I decided that I wanted to build products for the internet. Since then I've been wrapping my head around bits, bytes, and curly braces. I love the idea of merging art with technology.</p>
